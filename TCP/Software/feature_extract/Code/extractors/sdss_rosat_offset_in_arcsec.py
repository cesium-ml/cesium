...
class sdss_rosat_offset_in_arcsec(ContextFeatureExtractor): 
        """What is the offset of the rosat source?"""
        active = True
        extname = 'sdss_rosat_offset_in_arcsec' #extractor's name
        ...
        def extract(self):
                ...
                if not n.has_key("rosat_offset_in_arcsec"):
                    if self.verbose:
