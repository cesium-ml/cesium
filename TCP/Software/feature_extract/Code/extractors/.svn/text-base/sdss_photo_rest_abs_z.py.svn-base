...
class sdss_photo_rest_abs_z(ContextFeatureExtractor): 
        """What is the sdss_photo_rest_abs_z?"""
        active = True
        extname = 'sdss_photo_rest_abs_z' #extractor's name
        ...
        def extract(self):
                ...
                if not n.has_key("photo_rest_abs_z"):
                    if self.verbose:
