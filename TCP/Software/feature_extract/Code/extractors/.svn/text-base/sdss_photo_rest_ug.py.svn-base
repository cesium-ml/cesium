...
class sdss_photo_rest_ug(ContextFeatureExtractor): 
        """What is the restframe u - g color?"""
        active = True
        extname = 'sdss_photo_rest_ug' #extractor's name
        ...
        def extract(self):
                ...
                if not n.has_key("photo_rest_ug"):
                    if self.verbose:
