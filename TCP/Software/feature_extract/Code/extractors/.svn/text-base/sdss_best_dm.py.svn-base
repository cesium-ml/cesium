...
class sdss_best_dm(ContextFeatureExtractor): 
        """If a redshift is known, what is the distance modulus?"""
        active = True
        extname = 'sdss_best_dm' #extractor's name
