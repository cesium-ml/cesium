...
class sdss_photo_rest_abs_g(ContextFeatureExtractor): 
        """What is the sdss_photo_rest_abs_g?"""
        active = True
        extname = 'sdss_photo_rest_abs_g' #extractor's name
        ...
        def extract(self):
                ...
                if not n.has_key("photo_rest_abs_g"):
                    if self.verbose:
