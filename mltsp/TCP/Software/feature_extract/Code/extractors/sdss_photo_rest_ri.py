...
class sdss_photo_rest_ri(ContextFeatureExtractor): 
        """What is the restframe r - i color?"""
        active = True
        extname = 'sdss_photo_rest_ri' #extractor's name
        ...
        def extract(self):
                ...
                if not n.has_key("photo_rest_ri"):
                    if self.verbose:
