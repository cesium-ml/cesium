...
class sdss_photo_rest_abs_r(ContextFeatureExtractor): 
        """What is the sdss_photo_rest_abs_r?"""
        active = True
        extname = 'sdss_photo_rest_abs_r' #extractor's name
        ...
        def extract(self):
                ...
                if not n.has_key("photo_rest_abs_r"):
                    if self.verbose:
