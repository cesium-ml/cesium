...
class sdss_first_flux_in_mjy(ContextFeatureExtractor): 
        """What is the flux of the first source?"""
        active = True
        extname = 'sdss_first_flux_in_mjy' #extractor's name
        ...
        def extract(self):
                ...
                if not n.has_key("first_flux_in_mJy"):
                    if self.verbose:
