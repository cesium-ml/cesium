...
class sdss_best_zerr(ContextFeatureExtractor): 
        """If a redshift is known, what is it's error?"""
        active = True
        extname = 'sdss_best_zerr' #extractor's name
