...
class sdss_photo_rest_iz(ContextFeatureExtractor): 
        """What is the restframe i - z color?"""
        active = True
        extname = 'sdss_photo_rest_iz' #extractor's name
        ...
        def extract(self):
                ...
                if not n.has_key("photo_rest_iz"):
                    if self.verbose:
