...
class sdss_photo_rest_abs_u(ContextFeatureExtractor): 
        """What is the sdss_photo_rest_abs_u?"""
        active = True
        extname = 'sdss_photo_rest_abs_u' #extractor's name
        ...
        def extract(self):
                ...
                if not n.has_key("photo_rest_abs_u"):
                    if self.verbose:
