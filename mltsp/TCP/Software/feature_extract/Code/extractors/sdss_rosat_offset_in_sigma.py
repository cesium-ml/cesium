...
class sdss_rosat_offset_in_sigma(ContextFeatureExtractor): 
        """What is the offset of the rosat source?"""
        active = True
        extname = 'sdss_rosat_offset_in_sigma' #extractor's name
        ...
        def extract(self):
                ...
                if not n.has_key("rosat_offset_in_sigma"):
                    if self.verbose:
