...
class Dovi_SN:
    ...
    def PTF_SN_classifier(self,z,dz=0.1,sloan_colors=[],sloan_type=4,gal_type=0):
        """
        ...
        if (z-nsig*dz<max(z_grid)):
          ...
          Ia_z_1sigma = self.conf_interval(z_grid1,z_grid2,posterior_Ia_z,0.68)
          cc_z_1sigma = self.conf_interval(z_grid1,z_grid2,posterior_cc_z,0.68)
          z_1sigma = self.conf_interval(z_grid1,z_grid2,posterior_z,0.68)
          ...
          # 1-sigma confidence intervals
          IIp_z_1sigma = self.conf_interval(z_grid1,z_grid2,posterior_IIp_z,0.68)
          Ibc_z_1sigma = self.conf_interval(z_grid1,z_grid2,posterior_Ibc_z,0.68)
          IIn_z_1sigma = self.conf_interval(z_grid1,z_grid2,posterior_IIn_z,0.68)
          ...
          out_dict1 = {'high_z':False,\
            ...
            'z_1sigma|IIp':IIp_z_1sigma,'z_1sigma|Ibc':Ibc_z_1sigma,'z_1sigma|IIn':IIp_z_1sigma}
          ...
          out_dict1 = {'high_z':True,\
            ...
            'z_1sigma|IIp':z1sigma,'z_1sigma|Ibc':z1sigma,'z_1sigma|IIn':z1sigma}
    ...
    def main(self):
        ...
        try:
            closest_in_light_ttype = float(str(\
                feat_dict.get('closest_light_ttype',{}).get('val',None)))
        except:
            closest_in_light_ttype = None
        try:
        ...
        #### sdss_colors:
        try:
            sdss_photo_rest_ug = float(str(\
                feat_dict.get('sdss_photo_rest_ug',{}).get('val',None)))
        except:
            sdss_photo_rest_ug = None
        try:
            sdss_photo_rest_gr = float(str(\
                feat_dict.get('sdss_photo_rest_gr',{}).get('val',None)))
        except:
            sdss_photo_rest_gr = None
        try:
            sdss_photo_rest_ri = float(str(\
                feat_dict.get('sdss_photo_rest_ri',{}).get('val',None)))
        except:
            sdss_photo_rest_ri = None
        try:
            sdss_photo_rest_iz = float(str(\
                feat_dict.get('sdss_photo_rest_iz',{}).get('val',None)))
        except:
            sdss_photo_rest_iz = None
        ...
        self.debug_feat_tup = (closest_in_light,closest_in_light_ttype,closest_in_light_dm,sdss_best_offset_in_petro_g,sdss_best_z,sdss_best_dz,sdss_nearest_obj_type,sdss_photo_rest_ug,sdss_photo_rest_gr,sdss_photo_rest_ri,sdss_photo_rest_iz)
        ...
        if (sdss_best_offset_in_petro_g is not None) and \
           ...
           (sdss_best_offset_in_petro_g<sdss_threshold):
            ...
            if (sdss_photo_rest_ug is not None) and \
               (sdss_photo_rest_gr is not None) and \
               (sdss_photo_rest_ri is not None) and \
               (sdss_photo_rest_iz is not None):
                sloan_colors=[sdss_photo_rest_ug,sdss_photo_rest_gr,sdss_photo_rest_ri,sdss_photo_rest_iz]
                
        #(3) run the classifier?
        try:
            result_dict = self.PTF_SN_classifier(z,dz,sloan_colors=sloan_colors,gal_type=gal_type)
        except:
            # most likely sdss features not extracted/found
            result_dict = {}
...
if __name__ == '__main__':
    ...
    sn =  Dovi_SN(datamodel=d,doplot=False)#,doplot=True)
