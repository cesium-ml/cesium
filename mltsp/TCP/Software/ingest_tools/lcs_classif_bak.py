...
import subprocess
p = subprocess.Popen("/big_data/dstarr/src/TCP/Software/ingest_tools/lcs_classif.py http://lyra.berkeley.edu:5123/get_lc_data/?filename=dotastro_215153.dat&sep=,", shell=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, close_fds=True)
...
def main():
    ...
    classifier_dict = rc.read_randomForest_classifier_into_dict(r_name='rf.tr',
                                                     r_classifier_fpath="/big_data/dstarr/scratch/macc_wrapper_rfclfr.rdat")
