...
UPLOAD_FOLDER = os.path.join(DATA_PATH, "flask_mltp/flask_uploads")
MODELS_FOLDER = os.path.join(DATA_PATH, "flask_mltp/classifier_models")
FEATURES_FOLDER = os.path.join(DATA_PATH, "flask_mltp/extracted_features")
