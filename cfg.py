# cfg.py
#
# Config file for MLTP flask app.
#
...
# Specify list of general time-series features to be used (must correspond to those in lc_tools.LightCurve object attributes):
features_list = ["n_epochs","avg_err","med_err","std_err", #not using: "start","end",#not always provided: "ra","dec",
...
features_list_science = ["source_id",
...
ignore_feats_list_science = ["source_id",
					 "color_bv_extinction",
					 "color_diff_bj",
					 "color_diff_hk",
					 "color_diff_jh",
...
features_to_plot = ["freq1_harmonics_freq_0","freq1_harmonics_amplitude_0","median","fold2P_slope_90percentile","max","min","percent_difference_flux_percentile","freq1_harmonics_rel_phase_1"]
